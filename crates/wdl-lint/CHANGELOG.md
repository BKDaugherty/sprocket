...
* New lint rule `UnusedDocComments` to ensure users are warned if they document unsupported syntax items ([#PR_NUMBER])(https://github.com/stjude-rust-labs/sprocket/pull/PR_NUMBER).
